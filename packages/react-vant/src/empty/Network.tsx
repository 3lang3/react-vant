...
export const Network = (
  <svg viewBox="0 0 160 160">
    <defs>
      <linearGradient id={`${prefix}1`} x1="64.022%" y1="100%" x2="64.022%" y2="0%">
      ...
      <linearGradient id={`${prefix}5`} x1="0%" y1="43.982%" x2="100%" y2="54.703%">
        {renderStop('#EAEDF0', 0)}
        {renderStop('#DCDEE0', 100)}
      </linearGradient>
      <linearGradient id={`${prefix}6`} x1="94.535%" y1="43.837%" x2="5.465%" y2="54.948%">
        {renderStop('#EAEDF0', 0)}
        {renderStop('#DCDEE0', 100)}
      </linearGradient>
      <radialGradient
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g transform="translate(31 105)" fillRule="nonzero">
        ...
        <rect fill={`url(#${prefix}6)`} x="15" y="12" width="18" height="6" rx="1.114" />
      </g>
    </g>
  </svg>
);
