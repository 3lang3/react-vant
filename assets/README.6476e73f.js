...
`,P={code:y,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.5"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell, Dialog } from 'react-vant';
...
`,w={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.5"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell, Dialog } from 'react-vant';
...
`,M={code:_,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.5"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell, Dialog } from 'react-vant';
...
`,N={code:R,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.5"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell, Dialog } from 'react-vant';
...
`,I={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.5"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell, Dialog, Toast } from 'react-vant';
...
`,$={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.5"},"@react-vant/icons":{type:"NPM",value:"0.0.6"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell, Dialog } from 'react-vant';
import { Close } from '@react-vant/icons';
...
`,z={code:j,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.5"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Cell, Dialog, Toast } from 'react-vant';
import './style.less';
