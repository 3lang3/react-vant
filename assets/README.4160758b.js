...
`,P={code:f,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.2.3"},"@react-vant/icons":{type:"NPM",value:"0.0.10"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { ProductCard, Grid, FloatingPanel, Search, Divider } from 'react-vant'
import { LocationO, StarO, CartO, Discount } from '@react-vant/icons'
