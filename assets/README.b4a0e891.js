var o=Object.defineProperty,F=Object.defineProperties;var p=Object.getOwnPropertyDescriptors;var d=Object.getOwnPropertySymbols;var E=Object.prototype.hasOwnProperty,C=Object.prototype.propertyIsEnumerable;var c=(t,e,i)=>e in t?o(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,a=(t,e)=>{for(var i in e||(e={}))E.call(e,i)&&c(t,i,e[i]);if(d)for(var i of d(e))C.call(e,i)&&c(t,i,e[i]);return t},l=(t,e)=>F(t,p(e));import{j as u,a as n}from"./main.17132292.js";import{e7 as D,d8 as m,d9 as r,e as s,cB as g,a3 as v,aE as A,D as B,e8 as f}from"./FloatingPanel.4dc70d2c.js";var h=()=>u("div",{children:n(D,{anchors:[170,320,window.innerHeight*.8],children:[u(m,{}),n(r,{gutter:8,children:[u(r.Item,{icon:u(s,{}),onClick:()=>0,text:"\u9644\u8FD1"}),u(r.Item,{icon:u(g,{}),onClick:()=>0,text:"\u6536\u85CF"}),u(r.Item,{icon:u(v,{}),onClick:()=>0,text:"\u8D2D\u7269\u8F66"}),u(r.Item,{icon:u(A,{}),onClick:()=>0,text:"\u4F18\u60E0"})]}),u(B,{children:"\u597D\u7269\u63A8\u8350"}),Array.from(Array(5)).map((t,e)=>u(f,{title:"\u70ED\u5356\u5546\u54C1"+e,thumb:"https://img.yzcdn.cn/vant/ipad.jpeg",desc:"\u70ED\u5356\u5546\u54C1\uFF0C\u4F18\u60E0\u540E 2.00",num:3,price:"2.00"},e))]})});const x=`import React from 'react'
...
`,P={code:x,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.1.6"},"@react-vant/icons":{type:"NPM",value:"0.0.10"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { ProductCard, Grid, FloatingPanel, Search, Divider } from 'react-vant'
import { LocationO, StarO, CartO, Discount } from '@react-vant/icons'
