var B=Object.defineProperty,w=Object.defineProperties;var x=Object.getOwnPropertyDescriptors;var h=Object.getOwnPropertySymbols;var M=Object.prototype.hasOwnProperty,g=Object.prototype.propertyIsEnumerable;var p=(t,r,u)=>r in t?B(t,r,{enumerable:!0,configurable:!0,writable:!0,value:u}):t[r]=u,o=(t,r)=>{for(var u in r||(r={}))M.call(r,u)&&p(t,u,r[u]);if(h)for(var u of h(r))g.call(r,u)&&p(t,u,r[u]);return t},i=(t,r)=>w(t,x(r));import{r as l,a as n,j as e}from"./main.4b2a24f6.js";import{dL as d,C as s,d7 as m}from"./WaterMark.76b5a032.js";const c=[{text:"\u5168\u90E8\u5546\u54C1",value:0},{text:"\u65B0\u6B3E\u5546\u54C1",value:1},{text:"\u6D3B\u52A8\u5546\u54C1",value:2}],a=[{text:"\u9ED8\u8BA4\u6392\u5E8F",value:"a"},{text:"\u597D\u8BC4\u6392\u5E8F",value:"b"},{text:"\u9500\u91CF\u6392\u5E8F",value:"c"}];var v=()=>{const[t,r]=l.exports.useState({});return n(d,{value:t,onChange:u=>r(u),children:[e(d.Item,{name:"value1",options:c}),e(d.Item,{name:"value2",options:a})]})};const A=`import React, { useState } from 'react'
...
`,f={code:A,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { DropdownMenu } from 'react-vant'
import { option1, option2 } from './options'
...
`}},key:"dropdown-menu-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var D=()=>{const[t,r]=l.exports.useState({});return n(d,{value:t,onChange:u=>r(u),children:[e(d.Item,{name:"value1",options:c}),n(d.Item,{title:"\u7B5B\u9009",name:"value2",children:[e(s,{center:!0,title:"\u5305\u90AE",rightIcon:e(m,{size:24})}),e(s,{center:!0,title:"\u56E2\u8D2D",rightIcon:e(m,{size:24})})]})]})};const I=`import React, { useState } from 'react'
...
`,b={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { DropdownMenu, Cell, Switch } from 'react-vant'
import { option1 } from './options'
...
`}},key:"dropdown-menu-custom",meta:{title:"\u81EA\u5B9A\u4E49\u83DC\u5355\u5185\u5BB9"}};var E=()=>{const[t,r]=l.exports.useState({});return n(d,{activeColor:"#f44336",value:t,onChange:u=>r(u),children:[e(d.Item,{name:"value1",options:c}),e(d.Item,{name:"value2",options:a})]})};const y=`import React, { useState } from 'react'
import { DropdownMenu } from 'react-vant'
import { option1, option2 } from './options'
...
`,R={code:y,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { DropdownMenu } from 'react-vant'
import { option1, option2 } from './options'
...
`}},key:"dropdown-menu-color",meta:{title:"\u81EA\u5B9A\u4E49\u9AD8\u4EAE\u989C\u8272"}};var C=()=>{const[t,r]=l.exports.useState({});return n(d,{direction:"up",value:t,onChange:u=>r(u),children:[e(d.Item,{name:"value1",options:c}),e(d.Item,{name:"value2",options:a})]})};const S=`import React, { useState } from 'react'
import { DropdownMenu } from 'react-vant'
import { option1, option2 } from './options'
...
`,_={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { DropdownMenu } from 'react-vant'
import { option1, option2 } from './options'
...
`}},key:"dropdown-menu-direction",meta:{title:"\u5411\u4E0A\u5C55\u5F00"}};var F=()=>{const[t,r]=l.exports.useState({});return n(d,{value:t,onChange:u=>r(u),children:[e(d.Item,{disabled:!0,name:"value1",options:c}),e(d.Item,{disabled:!0,name:"value2",options:a})]})};const P=`import React, { useState } from 'react'
import { DropdownMenu } from 'react-vant'
import { option1, option2 } from './options'
...
`,V={code:P,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { DropdownMenu } from 'react-vant'
import { option1, option2 } from './options'
