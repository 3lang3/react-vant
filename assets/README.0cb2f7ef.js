...
`,T={code:y,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { hooks, Calendar, Cell } from 'react-vant';
...
`,M={code:$,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { hooks, Calendar, Cell } from 'react-vant';
...
`,L={code:P,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { hooks, Calendar, Cell } from 'react-vant';
...
`,_={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { hooks, Calendar, Cell } from 'react-vant';
...
`}},key:"calendar-range",meta:{title:"\u65E5\u671F\u8303\u56F4"}},I=t=>`${t.getMonth()+1}/${t.getDate()}`;var p=()=>e(r,{style:{height:500},showConfirm:!1,poppable:!1,onConfirm:t=>{b.info(I(t))}});const N=`import React from 'react';
...
`,z={code:N,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Toast, Calendar } from 'react-vant';
