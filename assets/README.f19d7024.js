...
`,I={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.0"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { CouponList, Popup, Toast, CouponCell } from 'react-vant';
import { data, disabledDiscountCoupon, disabledCoupon } from './demo';
