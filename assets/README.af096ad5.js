...
};`}},key:"progress-demo-3",meta:{title:"\u6837\u5F0F\u5B9A\u5236"}},s=u=>Math.min(Math.max(u,0),100);var E=()=>{const[u,d]=A.exports.useState(50);return r(P,{children:[e(n,{percentage:u}),r(D,{justify:"center",style:{marginTop:20},children:[e(h,{style:{marginRight:10},type:"primary",size:"small",onClick:()=>{d(o=>s(o+20))},children:"\u589E\u52A0"}),e(h,{type:"danger",size:"small",onClick:()=>{d(o=>s(o-20))},children:"\u51CF\u5C11"})]})]})};const R={code:`import React, { useState } from 'react';
