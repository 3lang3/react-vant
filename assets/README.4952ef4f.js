...
`,M={code:P,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Badge, Space } from 'react-vant';
import { Success, Cross, Down } from '@react-vant/icons';
...
`}},key:"badge-custom",meta:{title:"\u81EA\u5B9A\u4E49\u5FBD\u6807\u5185\u5BB9"}};var f=()=>d(i,{gap:20,children:[e(u,{content:"20",style:{marginRight:16}}),e(u,{content:"200",max:"99"})]});const j={code:`import React from 'react';
import { Space, Badge } from 'react-vant';
