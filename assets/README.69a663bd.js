var R=Object.defineProperty,k=Object.defineProperties;var I=Object.getOwnPropertyDescriptors;var s=Object.getOwnPropertySymbols;var w=Object.prototype.hasOwnProperty,V=Object.prototype.propertyIsEnumerable;var E=(t,d,r)=>d in t?R(t,d,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[d]=r,i=(t,d)=>{for(var r in d||(d={}))w.call(d,r)&&E(t,r,d[r]);if(s)for(var r of s(d))V.call(d,r)&&E(t,r,d[r]);return t},c=(t,d)=>k(t,I(d));import{j as u,r as l,F as h,a as e}from"./main.ef1f7c34.js";import{j as n,C as B,g as p,d1 as L,da as C,F as _,t as N,B as A,dd as T,dm as z}from"./WaterMark.5461c04c.js";var f=()=>u(n,{label:"\u6587\u672C",tooltip:"\u63D0\u793Atooltip",intro:u("div",{children:"We must make sure that your are a human."}),placeholder:"\u8BF7\u8F93\u5165\u6587\u672C"});const O={code:`import React, { useState } from 'react';
...
`,j={code:W,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.0.6"},react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import { ShopO, WarningO } from '@react-vant/icons';
import React, { useState } from 'react';
import { Cell, Field, Toast } from 'react-vant';
...
`,U={code:q,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"@react-vant/icons":{type:"NPM",value:"0.0.6"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Field, Flex, Popup, Picker, Button } from 'react-vant';
import { ArrowDown } from '@react-vant/icons';
