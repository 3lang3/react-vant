...
`,j={code:M,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cascader, Popup, Field, hooks } from 'react-vant';
import options from './options';
...
`}},key:"cascader-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var D=()=>{const[i,t]=E.useSetState({visible:!1,text:""});return u(c,{children:[e(h,{isLink:!0,value:i.text,readonly:!0,label:"\u5730\u533A",placeholder:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",onClick:()=>t({visible:!0})}),e(p,{visible:i.visible,round:!0,position:"bottom",onClose:()=>t({visible:!1}),children:e(v,{title:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",activeColor:"#f44336",options:s,onClose:()=>t({visible:!1}),onFinish:({selectedOptions:n})=>{t({visible:!1,text:n.map(l=>l.text).join("/")})}})})]})};const L=`import React from 'react';
import { Cascader, Popup, Field, hooks } from 'react-vant';
import options from './options';
...
`,R={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cascader, Popup, Field, hooks } from 'react-vant';
import options from './options';
...
`}},key:"cascader-color",meta:{title:"\u81EA\u5B9A\u4E49\u989C\u8272"}};var B=()=>{const[i,t]=E.useSetState({visible:!1,text:""}),[n,l]=N.exports.useState([{text:"\u6D59\u6C5F\u7701",value:"330000",children:[]}]),F=({value:o})=>{o===n[0].value&&(m.loading({message:"\u52A0\u8F7D\u4E2D...",duration:0}),setTimeout(()=>{m.clear();const r=JSON.parse(JSON.stringify(n));r[0].children=[{text:"\u676D\u5DDE\u5E02",value:"330100"},{text:"\u5B81\u6CE2\u5E02",value:"330200"}],l(r)},2e3))};return u(c,{children:[e(h,{isLink:!0,value:i.text,readonly:!0,label:"\u5730\u533A",placeholder:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",onClick:()=>t({visible:!0})}),e(p,{visible:i.visible,round:!0,position:"bottom",onClose:()=>t({visible:!1}),children:e(v,{title:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",options:n,onChange:F,onClose:()=>t({visible:!1}),onFinish:({selectedOptions:o})=>{t({visible:!1,text:o.map(r=>r.text).join("/")})}})})]})};const T=`import React, { useState } from 'react';
...
`,w={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Cascader, Toast, Popup, Field, hooks } from 'react-vant';
...
`}},key:"cascader-async",meta:{title:"\u5F02\u6B65\u52A0\u8F7D\u9009\u9879"}};var f=()=>{const[i,t]=E.useSetState({visible:!1,text:""});return u(c,{children:[e(h,{isLink:!0,value:i.text,readonly:!0,label:"\u5730\u533A",placeholder:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",onClick:()=>t({visible:!0})}),e(p,{visible:i.visible,round:!0,position:"bottom",onClose:()=>t({visible:!1}),children:e(v,{fieldNames:{text:"name",value:"code",children:"items"},title:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",options:[{name:"\u6D59\u6C5F\u7701",code:"330000",items:[{name:"\u676D\u5DDE\u5E02",code:"330100"}]},{name:"\u6C5F\u82CF\u7701",code:"320000",items:[{name:"\u5357\u4EAC\u5E02",code:"320100"}]}],onClose:()=>t({visible:!1}),onFinish:({selectedOptions:n})=>{t({visible:!1,text:n.map(l=>l.name).join("/")})}})})]})};const I=`import React from 'react';
import { Cascader, Popup, Field, hooks } from 'react-vant';
...
`,J={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cascader, Popup, Field, hooks } from 'react-vant';
...
`}},key:"cascader-fieldnames",meta:{title:"\u81EA\u5B9A\u4E49\u5B57\u6BB5\u540D"}};var y=()=>{const[i,t]=E.useSetState({visible:!1,text:A(["330000","330100","330103"],s),value:["330000","330100","330103"]});return u(c,{children:[e(h,{isLink:!0,value:i.text,readonly:!0,label:"\u5730\u533A",placeholder:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",errorMessage:u("div",{children:["\u5F53\u524D\u503C:",JSON.stringify(i.value)]}),onClick:()=>t({visible:!0})}),e(_,{block:!0,style:{margin:"10px auto",width:"90%"},type:"primary",size:"small",onClick:()=>t({value:["330000","330100","330104"],text:A(["330000","330100","330104"],s)}),children:"\u5916\u90E8\u8BBE\u7F6E"}),e(p,{visible:i.visible,round:!0,position:"bottom",onClose:()=>t({visible:!1}),children:e(v,{title:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",value:i.value,options:s,onClose:()=>t({visible:!1}),onFinish:({selectedOptions:n})=>{t({visible:!1,value:n.map(l=>l.value),text:n.map(l=>l.text).join("/")})}})})]})};function A(i,t){const n=[];return i.reduce((l,F)=>{const o=l.find(r=>r.value===F);return n.push(o.text),o.children},t),n.join("/")}const V=`import React from 'react';
...
`,$={code:V,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cascader, Button, Popup, Field, hooks } from 'react-vant';
import options from './options';
