var R=Object.defineProperty,k=Object.defineProperties;var I=Object.getOwnPropertyDescriptors;var s=Object.getOwnPropertySymbols;var w=Object.prototype.hasOwnProperty,V=Object.prototype.propertyIsEnumerable;var E=(n,r,t)=>r in n?R(n,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[r]=t,i=(n,r)=>{for(var t in r||(r={}))w.call(r,t)&&E(n,t,r[t]);if(s)for(var t of s(r))V.call(r,t)&&E(n,t,r[t]);return n},c=(n,r)=>k(n,I(r));import{j as u,r as d,F as h,a as e}from"./main.4b2a24f6.js";import{j as l,C as B,g as p,d1 as L,da as C,F as _,t as N,B as A,dd as T,dm as z}from"./WaterMark.76b5a032.js";var f=()=>u(l,{label:"\u6587\u672C",tooltip:"\u63D0\u793Atooltip",intro:u("div",{children:"We must make sure that your are a human."}),placeholder:"\u8BF7\u8F93\u5165\u6587\u672C"});const O={code:`import React, { useState } from 'react';
...
};`,lang:"jsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.jsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Field } from 'react-vant';
...
};`}},key:"field-demo",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var v=()=>{const[n,r]=d.exports.useState(""),[t,o]=d.exports.useState("");return u(h,{children:e(B.Group,{children:[u(l,{value:n,onChange:r,label:"\u6587\u672C",leftIcon:u(p,{}),rightIcon:u(L,{}),placeholder:"\u663E\u793A\u56FE\u6807",onClickLeftIcon:()=>C.info("\u5DE6\u4FA7\u56FE\u6807\u70B9\u51FB"),onClickRightIcon:()=>C.info("\u53F3\u4FA7\u56FE\u6807\u70B9\u51FB")}),u(l,{value:t,onChange:o,clearable:!0,label:"\u6587\u672C",leftIcon:u(p,{}),placeholder:"\u663E\u793A\u6E05\u9664\u56FE\u6807"})]})})};const W=`import { ShopO, WarningO } from '@react-vant/icons'
...
`,j={code:W,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.0.7"},react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import { ShopO, WarningO } from '@react-vant/icons'
import React, { useState } from 'react'
import { Cell, Field, Toast } from 'react-vant'
...
`}},key:"field-icon",meta:{title:"\u663E\u793A\u56FE\u6807"}};var D=()=>{const[n,r]=d.exports.useState(""),[t,o]=d.exports.useState("");return u(h,{children:e(B.Group,{children:[u(l,{value:n,error:!0,required:!0,label:"\u7528\u6237\u540D",placeholder:"\u8BF7\u8F93\u5165\u7528\u6237\u540D",onChange:r}),u(l,{value:t,required:!0,label:"\u624B\u673A\u53F7",placeholder:"\u8BF7\u8F93\u5165\u624B\u673A\u53F7",errorMessage:"\u624B\u673A\u53F7\u683C\u5F0F\u9519\u8BEF",onChange:o})]})})};const G=`import React, { useState } from 'react'
...
`,$={code:G,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Cell, Field } from 'react-vant'
...
`}},key:"field-error",meta:{title:"\u9519\u8BEF\u63D0\u793A"}},m=["86 \u{1F1E8}\u{1F1F3}","87 \u{1F1FA}\u{1F1F8}","88 \u{1F3F3}\uFE0F\u200D\u{1F308}","89 \u{1F3F3}\uFE0F\u200D\u26A7\uFE0F","90 \u{1F1F4}\u{1F1F2}","91 \u{1F1F5}\u{1F1EA}","92 \u{1F1E9}\u{1F1EA}"];var g=()=>{const[n,r]=d.exports.useState(""),[t,o]=d.exports.useState(!1),[a,F]=d.exports.useState(m[0]);return e(h,{children:[u(l,{value:n,center:!0,label:"\u77ED\u4FE1\u9A8C\u8BC1\u7801",placeholder:"\u624B\u673A\u53F7",onChange:r,prefix:e(_,{align:"center",onClick:()=>o(!0),children:["+",a," ",u(N,{style:{paddingLeft:8}})]}),suffix:u(A,{size:"small",type:"primary",children:"\u53D1\u9001"})}),u(T,{round:!0,visible:t,position:"bottom",onClose:()=>o(!1),children:u(z,{title:"\u6807\u9898",onConfirm:M=>{F(M),o(!1)},columns:m})})]})};const q=`import React, { useState } from 'react'
...
`}},key:"field-button",meta:{title:"\u63D2\u5165\u6309\u94AE"}};var x=()=>{const[n,r]=d.exports.useState(""),[t,o]=d.exports.useState(""),a=F=>F.replace(/\d/g,"");return e(h,{children:[u(l,{value:n,label:"\u6587\u672C",formatter:a,placeholder:"\u5728\u8F93\u5165\u65F6\u6267\u884C\u683C\u5F0F\u5316",onChange:r}),u(l,{value:t,label:"\u6587\u672C",formatter:a,formatTrigger:"onBlur",placeholder:"\u5728\u5931\u7126\u65F6\u6267\u884C\u683C\u5F0F\u5316",onChange:o})]})};const H=`import React, { useState } from 'react'
import { Field } from 'react-vant'
...
`,J={code:H,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Field } from 'react-vant'
...
`}},key:"field-formatter",meta:{title:"\u683C\u5F0F\u5316\u8F93\u5165\u5185\u5BB9"}};var b=()=>{const[n,r]=d.exports.useState("");return u(l,{rows:1,value:n,onChange:r,label:"\u7559\u8A00",type:"textarea",placeholder:"\u8BF7\u8F93\u5165\u7559\u8A00"})};const K={code:`import React, { useState } from 'react';
import { Field } from 'react-vant';
...
};`}},key:"field-demo-1",meta:{title:"\u9AD8\u5EA6\u81EA\u9002\u5E94"}};var y=()=>{const[n,r]=d.exports.useState("");return u(l,{rows:2,autoSize:!0,label:"\u7559\u8A00",type:"textarea",placeholder:"\u8BF7\u8F93\u5165\u7559\u8A00",value:n,onChange:r,maxLength:50,showWordLimit:!0})};const Q={code:`import React, { useState } from 'react';
import { Field } from 'react-vant';
...
};`}},key:"field-demo-2",meta:{title:"\u663E\u793A\u5B57\u6570\u7EDF\u8BA1"}};var S=()=>u(l,{label:"\u6587\u672C",placeholder:"\u8F93\u5165\u6846\u5185\u5BB9\u53F3\u5BF9\u9F50",align:"right"});const X={code:`import React from 'react';
import { Field } from 'react-vant';

export default () => {
  return <Field label="\u6587\u672C" placeholder="\u8F93\u5165\u6846\u5185\u5BB9\u53F3\u5BF9\u9F50" align="right" />;
};`,lang:"jsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.jsx":{type:"FILE",value:`import React from 'react';
import { Field } from 'react-vant';

export default () => {
  return <Field label="\u6587\u672C" placeholder="\u8F93\u5165\u6846\u5185\u5BB9\u53F3\u5BF9\u9F50" align="right" />;
};`}},key:"field-demo-3",meta:{title:"\u8F93\u5165\u6846\u5185\u5BB9\u5BF9\u9F50"}};var P=()=>{const n=d.exports.useRef(null);return u(l,{center:!0,ref:n,placeholder:"\u8BF7\u8F93\u5165\u6587\u672C",label:"\u6587\u672C",suffix:u(A,{size:"small",onClick:()=>{var r;(r=n==null?void 0:n.current)==null||r.focus()},children:"\u805A\u7126"})})};const Y=`import React, { useRef } from 'react'
...
`,Z={code:Y,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react'
import { Field, Button } from 'react-vant'
import type { FieldInstance } from 'react-vant'
