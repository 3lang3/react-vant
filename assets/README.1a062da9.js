...
`,I={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Popup, Cell } from 'react-vant';
...
`,R={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Cell, Popup, PopupPosition } from 'react-vant';
...
`,M={code:_,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import { Fire } from '@react-vant/icons';
import React, { useState } from 'react';
import { Popup, Cell } from 'react-vant';
...
`,N={code:V,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Popup, Cell } from 'react-vant';
...
`,O={code:$,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Popup, Cell } from 'react-vant';
...
`,z={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Popup, Cell, ConfigProvider } from 'react-vant';
