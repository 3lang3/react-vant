...
`,H={code:X,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.7"},"@react-vant/icons":{type:"NPM",value:"0.0.6"},clsx:{type:"NPM",value:"1.2.1"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Cell, Field, Stepper, Form, Switch, Radio, hooks } from 'react-vant';
import type { FloatingBallProps } from 'react-vant';
import Bubble from './bubble';
import Menu from './menu';
