var b=Object.defineProperty,v=Object.defineProperties;var y=Object.getOwnPropertyDescriptors;var B=Object.getOwnPropertySymbols;var R=Object.prototype.hasOwnProperty,x=Object.prototype.propertyIsEnumerable;var A=(t,n,i)=>n in t?b(t,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[n]=i,f=(t,n)=>{for(var i in n||(n={}))R.call(n,i)&&A(t,i,n[i]);if(B)for(var i of B(n))x.call(n,i)&&A(t,i,n[i]);return t},m=(t,n)=>v(t,y(n));import{j as u,a as e,r as s}from"./main.2ba34796.js";import{dI as a,dV as c,C as h,dJ as g}from"./WaterMark.d93c4a29.js";async function C(t){return new Promise((n,i)=>{setTimeout(()=>{t&&i(new Error("error")),n(Array.from({length:10},(F,l)=>l))},1e3)})}const P=()=>{const[t,n]=s.exports.useState([]),[i,F]=s.exports.useState(!1);return u(c,{finished:i,onLoad:async()=>{const E=await C();n(o=>[...o,...E]),t.length>=30&&F(!0)},children:t.map((E,o)=>u(h,{title:o+1},o))})},T=()=>{const[t,n]=s.exports.useState([]),[i,F]=s.exports.useState(!1),[l,E]=s.exports.useState(0);return u(c,{finished:i,errorText:"\u8BF7\u6C42\u5931\u8D25\uFF0C\u70B9\u51FB\u91CD\u65B0\u52A0\u8F7D",onLoad:async()=>{E(d=>d+1);const r=await C(l===1);n(d=>[...d,...r]),t.length>=30&&F(!0)},children:t.map((r,d)=>u(h,{title:d+1},d))})},w=()=>{const t=s.exports.useRef(null),[n,i]=s.exports.useState([]),[F,l]=s.exports.useState(!1),E=async r=>{const d=await C();i(p=>{const D=r?d:[...p,...d];return D.length>=30&&l(!0),D})};return u(g,{onRefresh:async()=>{l(!1),await E(1)},onRefreshEnd:()=>{var r;return(r=t.current)==null?void 0:r.check()},children:u(c,{ref:t,finished:F,onLoad:E,children:n.map((r,d)=>u(h,{title:d+1},d))})})};var L=()=>u("div",{className:"demo-list",children:e(a,{sticky:!0,children:[u(a.TabPane,{title:"\u57FA\u672C\u7528\u6CD5",children:u(P,{})}),u(a.TabPane,{title:"\u9519\u8BEF\u63D0\u793A",children:u(T,{})}),u(a.TabPane,{title:"\u4E0B\u62C9\u5237\u65B0",children:u(w,{})})]})});const S=`/* eslint-disable react/no-array-index-key */
...
`,k={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.45"},"index.tsx":{type:"FILE",value:`/* eslint-disable react/no-array-index-key */
import React, { useRef, useState } from 'react';
import { PullRefresh, List, Tabs, Cell } from 'react-vant';
import type { ListInstance } from 'react-vant';
import './style.less';
