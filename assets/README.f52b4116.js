...
`,L={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Picker, Toast } from 'react-vant';
...
`}},key:"picker-base",meta:{title:"\u57FA\u7840\u7528\u6CD5",card:!0}};var v=()=>{const[t,r]=a.useState(["\u5468\u4E8C","\u665A\u4E0A"]);return u(d,{value:t,onChange:(n,F,l)=>{h(`\u5F53\u524D\u503C\uFF1A${n}, \u5F53\u524D\u7D22\u5F15\uFF1A${l}`),r(n)},columns:[["\u5468\u4E00","\u5468\u4E8C","\u5468\u4E09","\u5468\u56DB","\u5468\u4E94"],["\u4E0A\u5348","\u4E0B\u5348","\u665A\u4E0A"]]})};const I=`import React from 'react';
import { Picker, Toast } from 'react-vant';
...
`,q={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Picker, Toast } from 'react-vant';
...
`,H={code:O,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Picker } from 'react-vant';
import { cascaderData } from './data';
...
`}},key:"picker-cascader",meta:{title:"\u7EA7\u8054\u9009\u62E9",card:!0}},G={\u6D59\u6C5F:["\u676D\u5DDE","\u5B81\u6CE2","\u6E29\u5DDE","\u5609\u5174","\u6E56\u5DDE"],\u798F\u5EFA:["\u798F\u5DDE","\u53A6\u95E8","\u8386\u7530","\u4E09\u660E","\u6CC9\u5DDE"]};async function J(t){return new Promise(r=>setTimeout(r,t))}async function K(t){return await J(1e3),G[t]}var x=()=>{const[t,r]=a.useState(!1),[n,F]=a.useState(),[l,g]=a.useState([{text:"\u6D59\u6C5F",children:[]},{text:"\u798F\u5EFA",children:[]}]);return u(V,{children:u(d,{loading:t,value:n,columns:l,onChange:async D=>{const o=D[0];if(!o)return;if(l.some(E=>E.text===o&&E.children.length>0)){F(D);return}r(!0);const P=await K(o);r(!1),g(E=>E.map(s=>s.text===o?i(c({},s),{children:P.map(m=>({text:m,value:m}))}):s))}})})};const Q=`import React from 'react';
import { Picker } from 'react-vant';
...
`,U={code:Q,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Picker } from 'react-vant';
...
`,X={code:W,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Picker } from 'react-vant';
...
`,uu={code:Z,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Picker, Field } from 'react-vant';
...
`}},key:"picker-popup",meta:{title:"\u542F\u7528\u5F39\u51FA\u5C42"}};var y=()=>{const[t,r]=a.useState(["\u798F\u5EFA","\u798F\u5DDE","\u53F0\u6C5F\u533A"]);return u(d,{title:"\u6807\u9898",value:t,onChange:r,columns:z,columnsFieldNames:{text:"cityName",children:"cities"}})};const eu=`import React from 'react';
import { Picker } from 'react-vant';
...
`,nu={code:eu,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Picker } from 'react-vant';
import { fieldNamesData } from './data';
