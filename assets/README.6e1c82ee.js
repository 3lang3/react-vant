...
`,k={code:f,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.36"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { NumberKeyboard, Cell, hooks, Toast } from 'react-vant';
...
`}},key:"number-keyboard-base",meta:{title:"\u57FA\u7840\u7528\u6CD5",card:!0}};var C=()=>{const[r,t]=s.useSetState({visible:!1,value:""});return e(F,{children:[u(y,{label:"\u53CC\u5411\u7ED1\u5B9A",value:r.value,readonly:!0,onClick:()=>t({visible:!0})}),u(n,{value:r.value,visible:r.visible,maxlength:6,onChange:d=>{t({value:d})},onBlur:()=>{t({visible:!1})}})]})};const x=`import React from 'react';
...
`,K={code:x,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.36"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Field, NumberKeyboard, hooks } from 'react-vant';
