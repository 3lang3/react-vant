...
`,R={code:k,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`}},key:"cell-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var C=()=>e(n,{children:Array.from({length:4}).map((d,t)=>e(l,{center:!0,title:`Avatar ${t}`,label:"Deserunt dolor ea eaque eos",icon:e(y,{width:44,height:44,src:"/demo_1.jpg",round:!0}),isLink:!0},t))});const w=`import React from 'react';
...
`,L={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell, Image } from 'react-vant';
...
`}},key:"cell-list",meta:{title:"\u7528\u6237\u5217\u8868"}};var p=()=>u(n,{children:[e(l,{title:"\u5355\u5143\u683C",value:"\u5185\u5BB9",size:"large"}),e(l,{title:"\u5355\u5143\u683C",value:"\u5185\u5BB9",label:"\u63CF\u8FF0\u4FE1\u606F",size:"large"})]});const G=`import React from 'react';
import { Cell } from 'react-vant';
...
`,N={code:G,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,$={code:z,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import { FireO, LocationO } from '@react-vant/icons';
import React from 'react';
import { Cell } from 'react-vant';
...
`,O={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,j={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,T={code:q,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,J={code:H,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,Q={code:K,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.2"},"index.tsx":{type:"FILE",value:`import { ShopO } from '@react-vant/icons';
import React from 'react';
import { Cell } from 'react-vant';
