...
`,M={code:z,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.3"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Uploader } from 'react-vant'
import './style.less'
...
`}},key:"uploader-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}},V="http://nextjs-upload-service.vercel.app/api/upload",a=async n=>{try{const t=new FormData;t.append("source",n);const o=await(await fetch(V,{method:"POST",body:t})).json();return delete o.image.status,o.image}catch{return{url:`demo_path/${n.name}`}}},h=[{url:"https://img.yzcdn.cn/vant/sand.jpg",filename:"\u56FE\u7247\u540D\u79F0"},{url:"https://img.yzcdn.cn/vant/tree.jpg",filename:"\u56FE\u7247\u540D\u79F0"}];var f=()=>e(i,{defaultValue:h,upload:a});const O=`import React from 'react'
import { Uploader } from 'react-vant'
...
`,T={code:O,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.3"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Uploader } from 'react-vant'
import { upload, demoData } from './utils'
import './style.less'
...
`},"utils.ts":{type:"FILE",value:`const DEMO_UPLOAD_API = 'http://nextjs-upload-service.vercel.app/api/upload'
...
`}},key:"uploader-upload",meta:{title:"\u81EA\u52A8\u4E0A\u4F20"}};var A=()=>e(i,{multiple:!0,upload:a,defaultValue:[h[0]],maxCount:2,maxSize:15*1024,onOversize:()=>k.info("\u6587\u4EF6\u5927\u5C0F\u4E0D\u80FD\u8D85\u8FC715kb")});const L=`import React from 'react'
...
`,S={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.3"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Toast, Uploader } from 'react-vant'
import { demoData, upload } from './utils'
import './style.less'
...
`}},key:"uploader-limit",meta:{title:"\u4E0A\u4F20\u9650\u5236"}};var B=()=>e(i,{defaultValue:h,upload:a,previewSize:60,uploadIcon:e(P,{}),previewCoverRender:n=>n.filename&&e("div",{style:{position:"absolute",bottom:0,width:" 100%",color:"#fff",fontSize:12,textAlign:"center",background:"#00000030"},children:n.filename})});const N=`import React from 'react'
import { Uploader } from 'react-vant'
import { upload, demoData } from './utils'
...
`,$={code:N,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.3"},"@react-vant/icons":{type:"NPM",value:"0.0.6"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Uploader } from 'react-vant'
import { upload, demoData } from './utils'
import { Fire } from '@react-vant/icons'
import './style.less'
...
`}},key:"uploader-preview",meta:{title:"\u81EA\u5B9A\u4E49\u9884\u89C8"}};var g=()=>e(i,{defaultValue:h,upload:a,onDelete:()=>w.confirm({title:"\u63D0\u793A",message:"\u786E\u8BA4\u5220\u9664?\u{1F914}"})});const q=`import React from 'react'
...
`,H={code:q,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.3"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Uploader, Dialog } from 'react-vant'
import { upload, demoData } from './utils'
import './style.less'
...
`}},key:"uploader-close",meta:{title:"\u5F02\u6B65\u5173\u95ED"}},Z=n=>{const[t,r]=s.useState([]),o=s.useRef(0);return s.useEffect(()=>{n.value!==void 0&&(!t[0]||n.value!==t[0].url)&&r([{url:n.value,id:o.current++}])},[n.value]),e(i,{value:t,upload:a,maxCount:1,onChange:p=>{var F,E;r(p);const y=(F=p[0])==null?void 0:F.url;(E=n.onChange)==null||E.call(n,y)}})};var D=()=>{const[n]=c.useForm();return u(c,{colon:!0,form:n,footer:e(R,{style:{marginTop:20},onClick:async()=>{const r=await n.validateFields();console.log(r)},type:"primary",round:!0,block:!0,children:"\u786E\u8BA4"}),children:[e(c.Item,{rules:[{required:!0,message:"\u8BF7\u4E0A\u4F20\u5934\u50CF"}],label:"\u4E0A\u4F20\u5934\u50CF",name:"avatar",initialValue:"https://iili.io/NZiS9e.png",children:e(Z,{})}),e(c.Item,{rules:[{required:!0,message:"\u8BF7\u4E0A\u4F20\u5934\u50CF"}],label:"\u4E0A\u4F20\u9644\u4EF6",name:"files",children:e(i,{accept:"*"})})]})};const W=`import React from 'react'
...
`,J={code:W,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.3"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Form, Uploader, UploaderValueItem, Button } from 'react-vant'
import { upload } from './utils'
import './style.less'
