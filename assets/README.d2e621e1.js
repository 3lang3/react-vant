var p=Object.defineProperty,C=Object.defineProperties;var T=Object.getOwnPropertyDescriptors;var a=Object.getOwnPropertySymbols;var v=Object.prototype.hasOwnProperty,D=Object.prototype.propertyIsEnumerable;var h=(d,n,r)=>n in d?p(d,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):d[n]=r,i=(d,n)=>{for(var r in n||(n={}))v.call(n,r)&&h(d,r,n[r]);if(a)for(var r of a(n))D.call(n,r)&&h(d,r,n[r]);return d},c=(d,n)=>C(d,T(n));import{a as u,j as e}from"./main.c6224286.js";import{dP as t}from"./WaterMark.dada66f0.js";const l=Array.from({length:3},(d,n)=>n+1);var o=()=>u("div",{className:"demo-tabs",children:[e(t,{children:l.map(d=>u(t.TabPane,{title:`\u6807\u7B7E${d}`,children:["\u4E0B\u5212\u7EBF\u6807\u7B7E\u9875 ",d]},d))}),e(t,{border:!0,type:"capsule",children:l.map(d=>u(t.TabPane,{title:`\u6807\u7B7E${d}`,children:["\u80F6\u56CA\u6807\u7B7E\u9875 ",d]},d))}),e(t,{border:!0,type:"jumbo",children:l.map(d=>u(t.TabPane,{badge:d,title:`\u6807\u7B7E${d}`,description:"\u63CF\u8FF0\u5185\u5BB9",children:["\u5E26\u63CF\u8FF0\u4FE1\u606F\u7684\u6807\u7B7E\u9875 ",d]},d))}),e(t,{type:"card",children:l.map(d=>u(t.TabPane,{title:`\u6807\u7B7E${d}`,children:["\u5361\u7247\u6807\u7B7E\u9875 ",d]},d))})]});const A=`import React from 'react';
  ...
  return (
    <div className="demo-tabs">
      ...
      <Tabs border type="jumbo">
        {items.map((item) => (
          <Tabs.TabPane badge={item} key={item} title={\`\u6807\u7B7E\${item}\`} description="\u63CF\u8FF0\u5185\u5BB9">
            \u5E26\u63CF\u8FF0\u4FE1\u606F\u7684\u6807\u7B7E\u9875 {item}
          </Tabs.TabPane>
        ))}
      </Tabs>
...
`,y={code:A,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Tabs } from 'react-vant';
import './style.less';
...
`}},key:"tabs-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var s=()=>e("div",{className:"demo-tabs",children:e(t,{active:"c",children:["a","b","c"].map((d,n)=>u(t.TabPane,{name:d,title:`\u6807\u7B7E${n+1}`,children:["\u5185\u5BB9 ",n+1]},d))})});const P={code:`import React from 'react';
import { Tabs } from 'react-vant';
...
};`,lang:"jsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.jsx":{type:"FILE",value:`import React from 'react';
import { Tabs } from 'react-vant';
...
};`}},key:"tabs-demo",meta:{title:"\u901A\u8FC7\u540D\u79F0\u5339\u914D"}};var F=()=>e("div",{className:"demo-tabs",children:e(t,{children:[1,2,3,4,5,6,7,8].map(d=>u(t.TabPane,{title:`\u6807\u7B7E${d}`,children:["\u5185\u5BB9 ",d]},d))})});const f={code:`import React from 'react';
import { Tabs } from 'react-vant';
...
};`}},key:"tabs-demo-1",meta:{title:"\u6807\u7B7E\u680F\u6EDA\u52A8"}};var b=()=>e("div",{className:"demo-tabs",children:u(t,{active:"c",children:[e(t.TabPane,{title:"\u6807\u7B7E1",children:"\u5185\u5BB91"}),e(t.TabPane,{title:"\u6807\u7B7E2",disabled:!0,children:"\u5185\u5BB92"}),e(t.TabPane,{title:"\u6807\u7B7E3",children:"\u5185\u5BB93"})]})});const x={code:`import React from 'react';
import { Tabs } from 'react-vant';
...
};`}},key:"tabs-demo-2",meta:{title:"\u7981\u7528\u6807\u7B7E"}};var m=()=>e("div",{className:"demo-tabs",children:e(t,{align:"start",children:[1,2,3].map(d=>u(t.TabPane,{title:`\u6807\u7B7E${d}`,children:["\u5185\u5BB9 ",d]},d))})});const g={code:`import React from 'react';
import { Tabs } from 'react-vant';
...
};`}},key:"tabs-demo-3",meta:{title:"\u5BF9\u9F50\u65B9\u5F0F"}};var E=()=>e("div",{className:"demo-tabs",children:e(t,{sticky:!0,swipeable:!0,children:[1,2,3,4].map(d=>u(t.TabPane,{title:`\u6807\u7B7E${d}`,children:["\u5185\u5BB9 ",d]},d))})});const k={code:`import React from 'react';
import { Tabs } from 'react-vant';
...
};`}},key:"tabs-demo-4",meta:{title:"\u7C98\u6027\u5E03\u5C40"}};var B=()=>e("div",{className:"demo-tabs",children:e(t,{sticky:!0,scrollspy:{autoFocusLast:!0,reachBottomThreshold:50},children:[1,2,3,4,5,6,7,8].map(d=>e(t.TabPane,{title:`\u6807\u7B7E${d}`,children:u("div",{style:{height:"50vh"},children:["\u5185\u5BB9 ",d]})},d))})});const N={code:`import React from 'react';
import { Tabs } from 'react-vant';
