var B=Object.defineProperty,T=Object.defineProperties;var I=Object.getOwnPropertyDescriptors;var h=Object.getOwnPropertySymbols;var C=Object.prototype.hasOwnProperty,g=Object.prototype.propertyIsEnumerable;var m=(a,u,r)=>u in a?B(a,u,{enumerable:!0,configurable:!0,writable:!0,value:r}):a[u]=r,i=(a,u)=>{for(var r in u||(u={}))C.call(u,r)&&m(a,r,u[r]);if(h)for(var r of h(u))g.call(u,r)&&m(a,r,u[r]);return a},c=(a,u)=>T(a,I(u));import{j as e,a as n,R as D}from"./main.4b2a24f6.js";import{ec as t,bd as o,cf as l,aZ as d,ck as b}from"./WaterMark.76b5a032.js";var E=()=>e("div",{className:"demo-tabbar",children:n(t,{children:[e(t.Item,{icon:e(o,{}),children:"\u6807\u7B7E"}),e(t.Item,{icon:e(l,{}),children:"\u6807\u7B7E"}),e(t.Item,{icon:e(d,{}),children:"\u6807\u7B7E"}),e(t.Item,{icon:e(b,{}),children:"\u6807\u7B7E"})]})});const A=`import React from 'react'
...
`,f={code:A,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"@react-vant/icons":{type:"NPM",value:"0.0.7"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Tabbar } from 'react-vant'
import { FriendsO, HomeO, Search, SettingO } from '@react-vant/icons'
...
`}},key:"tabbar-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var v=()=>{const[a,u]=D.useState("setting");return e("div",{className:"demo-tabbar",children:n(t,{value:a,onChange:r=>u(r),children:[e(t.Item,{name:"home",icon:e(o,{}),children:"\u6807\u7B7E"}),e(t.Item,{name:"search",icon:e(l,{}),children:"\u6807\u7B7E"}),e(t.Item,{name:"firends",icon:e(d,{}),children:"\u6807\u7B7E"}),e(t.Item,{name:"setting",icon:e(b,{}),children:"\u6807\u7B7E"})]})})};const O=`import React from 'react'
import { Tabbar } from 'react-vant'
import { FriendsO, HomeO, Search, SettingO } from '@react-vant/icons'
...
`,x={code:O,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"@react-vant/icons":{type:"NPM",value:"0.0.7"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Tabbar } from 'react-vant'
import { FriendsO, HomeO, Search, SettingO } from '@react-vant/icons'
...
`}},key:"tabbar-control",meta:{title:"\u53D7\u63A7\u7EC4\u4EF6"}};var F=()=>e("div",{className:"demo-tabbar",children:n(t,{children:[e(t.Item,{icon:e(o,{}),children:"\u6807\u7B7E"}),e(t.Item,{badge:{dot:!0},icon:e(l,{}),children:"\u6807\u7B7E"}),e(t.Item,{badge:{content:5},icon:e(d,{}),children:"\u6807\u7B7E"}),e(t.Item,{badge:{content:20},icon:e(b,{}),children:"\u6807\u7B7E"})]})});const S=`import React from 'react'
import { Tabbar } from 'react-vant'
import { FriendsO, HomeO, Search, SettingO } from '@react-vant/icons'
...
`,y={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"@react-vant/icons":{type:"NPM",value:"0.0.7"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Tabbar } from 'react-vant'
import { FriendsO, HomeO, Search, SettingO } from '@react-vant/icons'
...
`}},key:"tabbar-badge",meta:{title:"\u5FBD\u6807\u63D0\u793A"}};const s={active:"https://img.yzcdn.cn/vant/user-active.png",inactive:"https://img.yzcdn.cn/vant/user-inactive.png"};var p=()=>n("div",{className:"demo-tabbar",children:[n(t,{children:[e(t.Item,{icon:a=>e("img",{alt:"tab",src:a?s.active:s.inactive}),children:"\u56FE\u6807"}),e(t.Item,{icon:e(d,{}),children:"\u56FE\u6807"}),e(t.Item,{icon:e(b,{}),children:"\u56FE\u6807"})]}),e("br",{}),n(t,{activeColor:"#f44336",inactiveColor:"#000",children:[e(t.Item,{icon:e(o,{}),children:"\u989C\u8272"}),e(t.Item,{icon:e(l,{}),children:"\u989C\u8272"}),e(t.Item,{icon:e(d,{}),children:"\u989C\u8272"}),e(t.Item,{icon:e(b,{}),children:"\u989C\u8272"})]})]});const N=`import React from 'react'
import { Tabbar } from 'react-vant'
import { FriendsO, HomeO, Search, SettingO } from '@react-vant/icons'
import './style.less'
...
`,P={code:N,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"@react-vant/icons":{type:"NPM",value:"0.0.7"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Tabbar } from 'react-vant'
import { FriendsO, HomeO, Search, SettingO } from '@react-vant/icons'
import './style.less'
