...
`,R={code:k,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,L={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell, Image } from 'react-vant';
...
`}},key:"cell-list",meta:{title:"\u7528\u6237\u5217\u8868"}};var v=()=>u(n,{children:[e(l,{title:"\u5355\u5143\u683C",value:"\u5185\u5BB9",size:"large"}),e(l,{title:"\u5355\u5143\u683C",value:"\u5185\u5BB9",label:"\u63CF\u8FF0\u4FE1\u606F",size:"large"})]});const N=`import React from 'react';
import { Cell } from 'react-vant';
...
`,G={code:N,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`}},key:"cell-size",meta:{title:"\u5355\u5143\u683C\u5927\u5C0F"}};var p=()=>u(n,{children:[e(l,{title:"\u5355\u5143\u683C",icon:e(b,{})}),e(l,{title:"\u5355\u5143\u683C",icon:e(P,{})})]});const z=`import { FireO, LocationO } from '@react-vant/icons';
...
`,$={code:z,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.0.6"},react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import { FireO, LocationO } from '@react-vant/icons';
import React from 'react';
import { Cell } from 'react-vant';
...
`,O={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,S={code:j,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,T={code:q,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,J={code:H,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cell } from 'react-vant';
...
`,Q={code:K,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.0.6"},react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"0.0.3-dev.4"},"index.tsx":{type:"FILE",value:`import { ShopO } from '@react-vant/icons';
import React from 'react';
import { Cell } from 'react-vant';
