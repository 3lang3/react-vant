var B=Object.defineProperty,f=Object.defineProperties;var g=Object.getOwnPropertyDescriptors;var c=Object.getOwnPropertySymbols;var m=Object.prototype.hasOwnProperty,C=Object.prototype.propertyIsEnumerable;var s=(t,r,n)=>r in t?B(t,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[r]=n,a=(t,r)=>{for(var n in r||(r={}))m.call(r,n)&&s(t,n,r[n]);if(c)for(var n of c(r))C.call(r,n)&&s(t,n,r[n]);return t},o=(t,r)=>f(t,g(r));import{r as E,j as u,a as e}from"./main.e785bc9f.js";import{dI as d,dJ as h,d9 as A}from"./WaterMark.5aa7eb3e.js";var p=()=>{const[t,r]=E.exports.useState(0),n=E.exports.useMemo(()=>t?`\u5237\u65B0\u6B21\u6570: ${t}`:"\u4E0B\u62C9\u8BD5\u8BD5",[t]),l=i=>new Promise(F=>{setTimeout(()=>{i&&A.info("\u5237\u65B0\u6210\u529F"),r(t+1),F(!0)},1e3)});return u("div",{className:"demo-pull-refresh",children:e(d,{children:[u(d.TabPane,{title:"\u57FA\u7840\u7528\u6CD5",children:u(h,{onRefresh:()=>l(!0),onRefreshEnd:()=>console.log("onRefreshEnd"),children:u("p",{children:n})})}),u(d.TabPane,{title:"\u6210\u529F\u63D0\u793A",children:u(h,{successText:"\u5237\u65B0\u6210\u529F",onRefresh:()=>l(!1),children:u("p",{children:n})})}),u(d.TabPane,{title:"\u81EA\u5B9A\u4E49\u5185\u5BB9",children:u(h,{headHeight:80,pullingText:({distance:i})=>u("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge.png",style:{transform:`scale(${i/80})`}}),loosingText:()=>u("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge.png"}),loadingText:()=>u("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge-fire.jpg"}),onRefresh:()=>l(!0),children:u("p",{children:n})})})]})})};const D=`import React, { useState, useMemo } from 'react';
...
`,R={code:D,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.46"},"index.tsx":{type:"FILE",value:`import React, { useState, useMemo } from 'react';
import { PullRefresh, Tabs, Toast } from 'react-vant';
import './style.less';
