var x=Object.defineProperty,D=Object.defineProperties;var g=Object.getOwnPropertyDescriptors;var o=Object.getOwnPropertySymbols;var y=Object.prototype.hasOwnProperty,f=Object.prototype.propertyIsEnumerable;var F=(n,r,t)=>r in n?x(n,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[r]=t,i=(n,r)=>{for(var t in r||(r={}))y.call(r,t)&&F(n,t,r[t]);if(o)for(var t of o(r))f.call(r,t)&&F(n,t,r[t]);return n},c=(n,r)=>D(n,g(r));import{a as e,F as a,j as u,r as h}from"./main.9a06eeb7.js";import{C as l,dj as d,B as I,da as S}from"./WaterMark.0164b8b5.js";import{h as b}from"./index.e83438b5.js";var p=()=>{const[n,r]=b.useSetState({text:"",tel:"",digit:"",num:"",password:""});return e(a,{children:[u(l,{children:u(d,{value:n.text,onChange:t=>r({text:t}),placeholder:"\u8BF7\u8F93\u5165\u6587\u672C"})}),u(l,{children:u(d,{value:n.tel,type:"tel",onChange:t=>r({tel:t}),placeholder:"\u8BF7\u8F93\u5165\u624B\u673A\u53F7"})}),u(l,{children:u(d,{value:n.digit,type:"digit",onChange:t=>r({digit:t}),placeholder:"\u8BF7\u8F93\u5165\u6574\u6570"})}),u(l,{children:u(d,{value:n.num,type:"number",onChange:t=>r({num:t}),placeholder:"\u8BF7\u8F93\u5165\u6570\u5B57"})}),u(l,{children:u(d,{value:n.password,type:"password",onChange:t=>r({password:t}),placeholder:"\u8BF7\u8F93\u5165\u5BC6\u7801"})})]})};const T=`import React from 'react'
...
`,w={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell, Input, hooks } from 'react-vant'
...
`}},key:"input-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var E=()=>{const[n,r]=h.exports.useState("");return u(l,{children:u(d,{placeholder:"\u8BF7\u8F93\u5165\u6587\u672C",value:n,onChange:r,clearable:!0,clearTrigger:"always"})})};const M={code:`import React, { useState } from 'react';
...
};`}},key:"input-demo",meta:{title:"\u6E05\u9664\u6309\u94AE"}};var C=()=>u(l,{children:u(d,{prefix:"\u{1F481}",suffix:u(I,{size:"small",type:"primary",children:"\u53D1\u9001"}),placeholder:"\u8BF7\u8F93\u5165\u77ED\u4FE1\u9A8C\u8BC1\u7801"})});const P={code:`import React, { useState } from 'react';
...
};`}},key:"input-demo-1",meta:{title:"\u63D2\u5165\u5185\u5BB9"}};var s=()=>e(a,{children:[u(l,{children:u(d.TextArea,{placeholder:"\u591A\u884C\u8F93\u5165"})}),u(l,{style:{marginTop:10},children:u(d.TextArea,{placeholder:"\u81EA\u9002\u5E94\u9AD8\u5EA6",autoSize:!0})}),u(l,{style:{marginTop:10},children:u(d.TextArea,{placeholder:"\u6700\u5C0F\u9AD8\u5EA680\uFF0C\u6700\u5927\u9AD8\u5EA6120",autoSize:{minHeight:80,maxHeight:120}})})]});const L={code:`import React, { useState } from 'react';
import { Input, Cell } from 'react-vant';
...
};`}},key:"input-demo-2",meta:{title:"\u591A\u884C\u8F93\u5165"}};var B=()=>e(a,{children:[u(l,{children:u(d,{placeholder:"\u6700\u591A\u8F93\u516510\u4E2A\u5B57\u7B26",maxLength:10,onOverlimit:()=>S.info("\u4E0D\u80FD\u8D85\u8FC710\u4E2A\u5B57\u7B26\u54E6\u{1F37A}")})}),u(l,{style:{marginTop:10},children:u(d.TextArea,{placeholder:"\u5B57\u6570\u7EDF\u8BA1",maxLength:50,showWordLimit:!0})}),u(l,{style:{marginTop:10},children:u(d.TextArea,{placeholder:"\u81EA\u5B9A\u4E49\u8F93\u51FA",showWordLimit:({currentCount:n})=>e("span",{children:["\u5DF2\u7ECF\u8F93\u5165",n,"\u4E2A\u5B57\u5566 \u270D\uFE0F"]})})})]});const V={code:`import React, { useState } from 'react';
...
};`}},key:"input-demo-3",meta:{title:"\u5B57\u6570\u7EDF\u8BA1"}};var m=()=>{const[n,r]=h.exports.useState("");return e(a,{children:[u(l,{children:u(d,{placeholder:"\u5185\u5BB9\u5267\u4E2D",value:n,onChange:r,align:"center"})}),u(l,{children:u(d,{placeholder:"\u5185\u5BB9\u53F3\u5BF9\u9F50",value:n,onChange:r,align:"right"})})]})};const k={code:`import React, { useState } from 'react';
import { Input, Cell } from 'react-vant';
...
};`}},key:"input-demo-4",meta:{title:"\u5BF9\u9F50\u65B9\u5F0F"}};var A=()=>{const[n,r]=h.exports.useState("\u53EA\u8BFB\u6A21\u5F0F"),[t,v]=h.exports.useState("\u7981\u7528\u6A21\u5F0F");return e(a,{children:[u(l,{children:u(d,{value:n,onChange:r,readOnly:!0})}),u(l,{children:u(d,{value:t,onChange:v,disabled:!0})})]})};const R={code:`import React, { useState } from 'react';
import { Input, Cell } from 'react-vant';
