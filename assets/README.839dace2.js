...
`,g={code:R,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.2.5"},"@react-vant/icons":{type:"NPM",value:"0.0.10"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react'
import { CountDown, Grid, Toast } from 'react-vant'
import { PauseCircleO, PlayCircleO, Replay } from '@react-vant/icons'
import type { CountDownInstance } from 'react-vant'
