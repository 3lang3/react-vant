var p=Object.defineProperty,B=Object.defineProperties;var D=Object.getOwnPropertyDescriptors;var l=Object.getOwnPropertySymbols;var f=Object.prototype.hasOwnProperty,A=Object.prototype.propertyIsEnumerable;var a=(n,r,t)=>r in n?p(n,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[r]=t,d=(n,r)=>{for(var t in r||(r={}))f.call(r,t)&&a(n,t,r[t]);if(l)for(var t of l(r))A.call(r,t)&&a(n,t,r[t]);return n},c=(n,r)=>B(n,D(r));import{j as u,a as e,F as h,r as v}from"./main.5e54c296.js";import{dX as i,dc as w,db as o,c2 as x,bR as y,c as b}from"./FloatingPanel.5bd30ec3.js";var s=()=>u(i,{time:30*60*60*1e3});const S={code:`import React from 'react';
...
export default () => {
  return <CountDown time={30 * 60 * 60 * 1000} format="DD \u5929 HH \u65F6 mm \u5206 ss \u79D2" />;
};`}},key:"count-down-demo-1",meta:{title:"\u81EA\u5B9A\u4E49\u683C\u5F0F"}};var m=()=>u(i,{time:30*60*60*1e3,millisecond:!0,format:"HH:mm:ss:SS"});const P={code:`import React from 'react';
import { CountDown } from 'react-vant';
export default () => {
...
export default () => {
  return <CountDown time={30 * 60 * 60 * 1000} millisecond format="HH:mm:ss:SS" />;
};`}},key:"count-down-demo-2",meta:{title:"\u6BEB\u79D2\u7EA7\u6E32\u67D3"}};var E=()=>u("div",{className:"demo-count-down",children:u(i,{time:30*60*60*1e3,millisecond:!0,format:"HH:mm:ss:SS",children:n=>e(h,{children:[u("span",{className:"block",children:n.hours}),u("span",{className:"colon",children:":"}),u("span",{className:"block",children:n.minutes}),u("span",{className:"colon",children:":"}),u("span",{className:"block",children:n.seconds})]})})});const N={code:`import React from 'react';
import { CountDown } from 'react-vant';
...
`}},key:"count-down-demo-3",meta:{title:"\u81EA\u5B9A\u4E49\u6837\u5F0F"}};var C=()=>{const n=v.exports.useRef();return e(h,{children:[u(i,{ref:n,time:3e3,millisecond:!0,format:"ss:SSS",autoStart:!1,onFinish:()=>w.info("\u5012\u8BA1\u65F6\u7ED3\u675F")}),u("br",{}),e(o,{columnNum:3,children:[u(o.Item,{icon:u(x,{}),text:"\u5F00\u59CB",onClick:()=>n.current.start()}),u(o.Item,{icon:u(y,{}),text:"\u6682\u505C",onClick:()=>n.current.pause()}),u(o.Item,{icon:u(b,{}),text:"\u91CD\u7F6E",onClick:()=>n.current.reset()})]})]})};const R=`import React, { useRef } from 'react'
...
`,g={code:R,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.3.1"},"@react-vant/icons":{type:"NPM",value:"0.0.10"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react'
import { CountDown, Grid, Toast } from 'react-vant'
import { PauseCircleO, PlayCircleO, Replay } from '@react-vant/icons'
import type { CountDownInstance } from 'react-vant'
