...
};`}},key:"popover-demo",meta:{title:"\u57FA\u7840\u7528\u6CD5"}},j=[{text:"\u9009\u9879\u4E00"},{text:"\u9009\u9879\u4E8C"}],v=["top","top-start","top-end","left","left-start","left-end","right","right-start","right-end","bottom","bottom-start","bottom-end"];var A=()=>{const u=h.exports.useRef(null),[n,r]=h.exports.useState(!1),[l,P]=h.exports.useState(v[0]);return t(C,{children:[e(R,{title:"\u9009\u62E9\u5F39\u51FA\u4F4D\u7F6E",onClick:()=>r(!0),isLink:!0}),t(M,{round:!0,position:"bottom",visible:n,onClose:()=>r(!1),children:[e("div",{style:{display:"flex",justifyContent:"center",margin:"110px 0"},children:e(o,{ref:u,theme:"dark",actions:j,onSelect:a=>p.info(a.text),placement:l,reference:e("div",{style:{width:60,height:60,backgroundColor:"#3f45ff",borderRadius:8}})})}),e(O,{showToolbar:!1,columns:v,onChange:a=>{P(a),setTimeout(()=>u.current.show(),0)}})]})]})};const G={code:`import React, { useRef, useState } from 'react';
...
};`,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React, { useRef, useState } from 'react';
import { Toast, Popover, Popup, Picker, Cell } from 'react-vant';
import type { PopoverInstance, PopoverPlacement } from 'react-vant';
...
`,$={code:z,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { AddO, MoreO, MusicO } from '@react-vant/icons';
import { Space, Toast, Button, Popover } from 'react-vant';
...
`}},key:"popover-config",meta:{title:"\u9009\u9879\u914D\u7F6E"}};var x=()=>{const u=h.exports.useRef(null);return e(C,{children:e(o,{ref:u,placement:"top-start",reference:e(i,{type:"primary",children:"\u81EA\u5B9A\u4E49\u5185\u5BB9"}),children:e(m,{square:!0,border:!1,columnNum:3,style:{width:240},children:Array.from({length:6},(n,r)=>e(m.Item,{onClick:()=>{var l;return(l=u.current)==null?void 0:l.hide()},icon:e(N,{}),text:"\u6587\u5B57"},r))})})})};const q=`import React, { useRef } from 'react';
...
`,Z={code:q,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.1"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react';
import { PhotoO } from '@react-vant/icons';
import { Popover, Button, Grid } from 'react-vant';
import type { PopoverInstance } from 'react-vant';
