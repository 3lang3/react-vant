...
`,g={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.45"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { ShareSheet, Cell } from 'react-vant';
...
`,y={code:k,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.45"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { ShareSheet, Cell } from 'react-vant';
...
`,P={code:V,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.45"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { ShareSheet, Cell } from 'react-vant';
...
`,z={code:q,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.45"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Cell, ShareSheet } from 'react-vant';
