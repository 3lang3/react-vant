var p=Object.defineProperty,b=Object.defineProperties;var v=Object.getOwnPropertyDescriptors;var B=Object.getOwnPropertySymbols;var y=Object.prototype.hasOwnProperty,R=Object.prototype.propertyIsEnumerable;var A=(n,i,t)=>i in n?p(n,i,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[i]=t,f=(n,i)=>{for(var t in i||(i={}))y.call(i,t)&&A(n,t,i[t]);if(B)for(var t of B(i))R.call(i,t)&&A(n,t,i[t]);return n},m=(n,i)=>b(n,v(i));import{j as u,a as e,r as l}from"./main.dadcdafb.js";import{dO as F,d_ as h,C as E,dP as x}from"./WaterMark.9e8c6b76.js";async function D(n){return new Promise((i,t)=>{setTimeout(()=>{n&&t(new Error("error")),i(Array.from({length:10},(a,o)=>o))},2e3)})}const P=()=>{const[n,i]=l.exports.useState([]),[t,a]=l.exports.useState(!1);return u(h,{finished:t,onLoad:async()=>{const c=await D();i(r=>[...r,...c]),n.length>=30&&a(!0)},children:n.map((c,r)=>u(E,{title:r+1},r))})},T=()=>{const[n,i]=l.exports.useState([]),[t,a]=l.exports.useState(!1),[o,c]=l.exports.useState(0);return u(h,{finished:t,errorText:"\u8BF7\u6C42\u5931\u8D25\uFF0C\u70B9\u51FB\u91CD\u65B0\u52A0\u8F7D",onLoad:async()=>{c(s=>s+1);const d=await D(o===1);i(s=>[...s,...d]),n.length>=30&&a(!0)},children:n.map((d,s)=>u(E,{title:s+1},s))})},w=()=>{const[n,i]=l.exports.useState([]),[t,a]=l.exports.useState(!1),o=async r=>{const d=await D();i(s=>{const C=r?d:[...s,...d];return C.length>=30&&a(!0),C})};return u(x,{onRefresh:async()=>{a(!1),await o(1)},children:u(h,{finished:t,onLoad:o,children:n.map((r,d)=>u(E,{title:d+1},d))})})};var L=()=>u("div",{className:"demo-list",children:e(F,{sticky:!0,children:[u(F.TabPane,{title:"\u57FA\u672C\u7528\u6CD5",children:u(P,{})}),u(F.TabPane,{title:"\u9519\u8BEF\u63D0\u793A",children:u(T,{})}),u(F.TabPane,{title:"\u4E0B\u62C9\u5237\u65B0",children:u(w,{})})]})});const g=`/* eslint-disable react/no-array-index-key */
...
`,S={code:g,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.4"},"index.tsx":{type:"FILE",value:`/* eslint-disable react/no-array-index-key */
import React, { useState } from 'react'
import { PullRefresh, List, Tabs, Cell } from 'react-vant'
import './style.less'
