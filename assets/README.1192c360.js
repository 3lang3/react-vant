...
`,j={code:M,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.44"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cascader, Popup, Field, hooks } from 'react-vant';
import options from './options';
...
`,R={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.44"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cascader, Popup, Field, hooks } from 'react-vant';
import options from './options';
...
`,w={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.44"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Cascader, Toast, Popup, Field, hooks } from 'react-vant';
...
`,J={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.44"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cascader, Popup, Field, hooks } from 'react-vant';
...
`}},key:"cascader-fieldnames",meta:{title:"\u81EA\u5B9A\u4E49\u5B57\u6BB5\u540D"}};var y=()=>{const[i,t]=v.useSetState({visible:!1,text:A(["330000","330100","330103"],s),value:["330000","330100","330103"]});return u(c,{children:[e(h,{isLink:!0,value:i.text,readonly:!0,label:"\u5730\u533A",placeholder:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",errorMessage:u("div",{children:["\u5F53\u524D\u503C:",JSON.stringify(i.value)]}),onClick:()=>t({visible:!0})}),e(N,{block:!0,style:{margin:"10px auto",width:"90%"},type:"primary",size:"small",onClick:()=>t({value:["330000","330100","330104"],text:A(["330000","330100","330104"],s)}),children:"\u5916\u90E8\u8BBE\u7F6E"}),e(p,{visible:i.visible,round:!0,position:"bottom",onClose:()=>t({visible:!1}),children:e(E,{title:"\u8BF7\u9009\u62E9\u6240\u5728\u5730\u533A",value:i.value,options:s,onClose:()=>t({visible:!1}),onFinish:({selectedOptions:n})=>{t({visible:!1,value:n.map(l=>l.value),text:n.map(l=>l.text).join("/")})}})})]})};function A(i,t){const n=[];return i.reduce((l,F)=>{const a=l.find(o=>o.value===F);return n.push(a.text),a.children},t),n.join("/")}const V=`import React from 'react';
...
`,$={code:V,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.44"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Cascader, Button, Popup, Field, hooks } from 'react-vant';
import options from './options';
