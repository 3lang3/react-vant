...
`,z={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Radio, Toast } from 'react-vant'
...
`}},key:"radio-async",meta:{title:"\u5F02\u6B65\u66F4\u65B0",card:!0}};var A=()=>{const[a,t]=s.exports.useState("");return e(r.Group,{value:a,children:u(o.Group,{children:[e(o,{clickable:!0,title:"\u5355\u9009\u68461",icon:e(p,{}),onClick:()=>t("1"),rightIcon:e(r,{name:"1"})}),e(o,{clickable:!0,title:"\u5355\u9009\u68462",icon:e(p,{}),onClick:()=>t("2"),rightIcon:e(r,{name:"2"})})]})})};const T=`import { ShopO } from '@react-vant/icons'
...
`,_={code:T,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.0.7"},react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"3.0.0-rc.8"},"index.tsx":{type:"FILE",value:`import { ShopO } from '@react-vant/icons'
import React, { useState } from 'react'
import { Radio, Cell } from 'react-vant'
